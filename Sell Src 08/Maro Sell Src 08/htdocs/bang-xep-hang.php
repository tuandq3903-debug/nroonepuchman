...
<div class="p-1 mt-1 ibox-content" style="border-radius: 7px; box-shadow: 0px 0px 5px black; background-color: #00CC66; border-radius: 15px;">
    ...
    <body>
        ...
        <div class="container color-forum pt-2">
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG TOP SỨC MẠNH NGỌC RỒNG</h6>
...
LIMIT 10;");
            ...
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG TOP NẠP NGỌC RỒNG</h6>
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                <th>#</th>
            ...
            <div class="row">
                <div class="col">
                    <h6 class="text-center">BẢNG XẾP HẠNG TOP NHIỆM VỤ NGỌC RỒNG</h6>
                    <table class="table table-borderless text-center">
                        <tbody>
                            <tr>
                                <th>#</th>
