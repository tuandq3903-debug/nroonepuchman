...
public class ConstMob {
    ...
    public static final byte GA = 83;
    public static final byte NGUA = 84;
    public static final byte UNKNOW = 85;
    public static final byte BIRD = 86;
    public static final byte BEE = 87;
    public static final byte HELMAN_DO = 88;
    public static final byte HELMAN_XANH = 89;
    public static final byte THAYMA  = 90;
    public static final byte BU_NHIN = 91;
    public static final byte PHU_THUY = 92;
    public static final byte THO = 93;
    public static final byte TOPPO = 94;
    public static final byte GODZILA = 95;
    public static final byte KING_KONG = 96;
