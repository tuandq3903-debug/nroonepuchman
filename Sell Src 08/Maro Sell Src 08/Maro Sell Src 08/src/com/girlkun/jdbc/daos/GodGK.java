...
//                            GirlkunServer.gI().stopConnect();
                            Service.getInstance().sendThongBaoOK(session, "Vui Lòng Dùng Version 2.2.0 - 2.2.9 Để Đăng Nhập");
                        } else {
                            Player plInGame = Client.gI().getPlayerByUser(session.userId);
                            if (plInGame != null) {
                                Client.gI().kickSession(plInGame.getSession());
                            ...
                            dataArray = (JSONArray) jv.parse(rs.getString("data_diem"));
                            player.NguHanhSonPoint = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.point_gapthu = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.point_trungthu = Integer.parseInt(String.valueOf(dataArray.get(2)));
                            player.point_dosat = Integer.parseInt(String.valueOf(dataArray.get(3)));
                            player.chucNangNhanBua = Integer.parseInt(String.valueOf(dataArray.get(4)));
                            ...
                            dataArray = (JSONArray) jv.parse(rs.getString("data_trung_thu"));
                            ...
                            dataArray = (JSONArray) jv.parse(rs.getString("data_chucphuc"));
                            player.chuc_phuc_sd = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            player.chuc_phuc_hp = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            player.chuc_phuc_ki = Integer.parseInt(String.valueOf(dataArray.get(2)));
                            dataArray.clear();
                            ...
                            player.nPoint.defg = Long.parseLong(String.valueOf(dataArray.get(8)));
