        ...
        if (param > 0) {
            ...
            try {
                ...
                if (player.getSession() != null && player.getSession().version == 999) {
                    ...
                    msg.writer().writeInt(Util.fromLongtoInt(param));// số tn cần cộng
                }
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            msg = Service.gI().messageSubCommand((byte) 6);
                ...
                msg.writer().writeInt(Util.fromLongtoInt(player.nPoint.mp));
            }
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(player.inventory.gem);//luong
                ...
                msg.writer().writeInt(Util.fromLongtoInt(player.nPoint.hp));// chp
                msg.writer().writeInt(Util.fromLongtoInt(player.nPoint.mp));// cmp
            }
