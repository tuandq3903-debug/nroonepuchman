...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.isPl()) {
            ...
            if (player.itemTime.isBatGioi) {
                int id = 16506;
                sendItemTime(player, id, (int) ((300000 - (System.currentTimeMillis() - player.itemTime.lastTimeBatGioi)) / 1000));
            }
            if (player.itemTime.isDoiNhi) {
                int id = 6094;
                sendItemTime(player, id, (int) ((300000 - (System.currentTimeMillis() - player.itemTime.lastTimeDoiNhi)) / 1000));
            }
        }
        if (player.itemTime.isnuocmiakhonglo) {
            sendItemTime(player, 17220, (int) ((TIME_NUOC_MIA - (System.currentTimeMillis() - player.itemTime.lastnuocmiakhonglo)) / 1000));
        }
        if (player.itemTime.isnuocmiathom) {
            sendItemTime(player, 17221, (int) ((TIME_NUOC_MIA - (System.currentTimeMillis() - player.itemTime.lastnuocmiathom)) / 1000));
        }
        if (player.itemTime.isnuocmiasaurieng) {
            sendItemTime(player, 17222, (int) ((TIME_NUOC_MIA - (System.currentTimeMillis() - player.itemTime.lastnuocmiasaurieng)) / 1000));
        }
        if (player.itemTime.is1Trung) {
            sendItemTime(player, 4042, (int) ((TIME_TRUNG_THU_10P - (System.currentTimeMillis() - player.itemTime.last1Trung)) / 1000));
        }
        if (player.itemTime.is2Trung) {
            sendItemTime(player, 4043, (int) ((TIME_TRUNG_THU_10P - (System.currentTimeMillis() - player.itemTime.last2Trung)) / 1000));
        }
        if (player.itemTime.isgaQuay) {
            sendItemTime(player, 8132, (int) ((TIME_TRUNG_THU_10P - (System.currentTimeMillis() - player.itemTime.lastgaQuay)) / 1000));
        }
        if (player.itemTime.isthapCam) {
            sendItemTime(player, 8131, (int) ((TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastthapCam)) / 1000));
        }
    ...
    public void sendTextDoSat(Player player) {
        int totalTime = 300000;
        int secondPassed = (int) ((System.currentTimeMillis() - System.currentTimeMillis() - totalTime) / 1000);
        int secondsLeft = (totalTime / 1000) - secondPassed;
        ItemTimeService.gI().sendTextTime(player, TEXT_DO_SAT, "Time Đồ Sát:", secondsLeft);
    }
