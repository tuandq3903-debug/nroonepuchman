...
public class EffectSkillService {
    ...
    public void setBatGioi(Player player, long lastTimeBatGioi, int timeBatGioi) {
        player.effectSkin.isBatGioi = true;
        player.effectSkin.lastTimeBatGioi = lastTimeBatGioi;
        player.effectSkin.timeBatGioi = timeBatGioi;
    }

    public void removeBatGioi(Player player) {
        player.effectSkin.isBatGioi = false;
        Service.getInstance().Send_Caitrang(player);
        sendEffectPlayer(player, player, TURN_OFF_EFFECT, STONE_EFFECT);
    }
...
//        player.effectSkill.timeAnTroi = timeAnTroi;
    ...
    public void sendEffectVolution(Player player) {
        ...
        try {
            ...
            com.girlkun.utils.Logger.logException(EffectSkillService.class,
                    e);
