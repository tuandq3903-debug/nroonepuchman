                ...
                default:
                    switch (item.template.id) {
                        ...
                        case 1105://hop qua skh, item 2002 xd
                            ...
                            break;
                        case 1352:
                            if (pl.chuc_phuc_sd < 1000) {
                                pl.nPoint.dameg += 5;
                                pl.chuc_phuc_sd++;
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                            } else {
                                Service.gI().sendThongBao(pl, "Bạn Đã Đủ Level Chúc Phúc");
                            }
                            break;
                        case 1353:
                            if (pl.chuc_phuc_hp < 1000) {
                                pl.nPoint.hpg += 5;
                                pl.chuc_phuc_hp++;
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                            } else {
                        ...
                        case 1260:
                            if (pl.pet != null) {
                                NpcService.gI().createMenuConMeo(pl, ConstNpc.menu_detu, -1, "|7|Ngọc Rồng One Puch Man!!!!\n"
                                        ...
                                        + "Chúc ngươi may mắn!!!", "Trái Đất", "Namec", "Xayda", "Từ chổi");
                                InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1);
                            } else {
...
//         RewardService.gI().initBaseOptionSaoPhaLe(itemReward);
    ...
    private void hopQuaKichHoat(Player player, Item item) {
        NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_OPTION_USE_ITEM1105, -1, "Chọn hành tinh của bạn muốn mở ",
                "Set trái đất",
                "Set namec",
                "Set xayda",
                "Từ chổi");
