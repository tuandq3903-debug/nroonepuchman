...
public class ItemService {
    ...
    public ItemMap itemMapSKHLV(Zone zone, int tempId, int quantity, int x, int y, long playerId, int skhid) {
        ItemMap item = createItemMapSetKichHoat(zone, tempId, quantity, x, y, playerId);
        if (item != null) {
            item.options.addAll(ItemService.gI().getListOptionItemShop((short) tempId));
            item.options.add(new Item.ItemOption(skhid, 2));
    ...
    public int randomSKHLV(byte gender) {
        if (gender == 3) {
            gender = 2;
        }
        int[][] options = {{224, 223, 225}, {226, 227, 228}, {229, 230, 231}};
        int skhv1 = 25;
        int skhv2 = 35;
        int skhc = 40;
        int skhId = -1;
    ...
    public int optionIdSKHLV(int skhId) {
        switch (skhId) {
            case 224: //Set Arriety Taiyoken
                return 236;
            case 223: //Set Arriety Genki
                return 235;
            case 225: //Set Arriety Kamejoko
                return 237;
            case 226: //Set Arriety KI
                return 238;
            case 227: //Set Arriety Dame
                return 239;
            case 228: //Set Arriety Summon
                return 240;
            case 229: //Set Arriety Galick
                return 232;
            case 230: //Set Arriety Monkey
                return 233;
            case 231: //Set Arriety HP
                return 234;
        }
        return 0;
    }
    ...
    public void setSongoku(Player player) throws Exception {
        Item hq = InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 1351);
        ...
        ao.itemOptions.add(new ItemOption(243, 0));
        quan.itemOptions.add(new ItemOption(243, 0));
        gang.itemOptions.add(new ItemOption(243, 0));
        giay.itemOptions.add(new ItemOption(243, 0));
        rd.itemOptions.add(new ItemOption(243, 0));
        ao.itemOptions.add(new ItemOption(224, 0));
        quan.itemOptions.add(new ItemOption(224, 0));
        gang.itemOptions.add(new ItemOption(224, 0));
        giay.itemOptions.add(new ItemOption(224, 0));
        rd.itemOptions.add(new ItemOption(224, 0));
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 4) {
            ...
            InventoryServiceNew.gI().addItemBag(player, gang);
            InventoryServiceNew.gI().addItemBag(player, giay);
            InventoryServiceNew.gI().addItemBag(player, rd);
            InventoryServiceNew.gI().sendItemBags(player);
    ...
    public void setThenXinHang(Player player) throws Exception {
        ...
        Item giay = ItemService.gI().otpKH((short) 27);
        Item rd = ItemService.gI().otpKH((short) 12);
        ao.itemOptions.add(new ItemOption(241, 0));
        quan.itemOptions.add(new ItemOption(241, 0));
        ...
        giay.itemOptions.add(new ItemOption(222, 0));
        rd.itemOptions.add(new ItemOption(222, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setKaioKen(Player player) throws Exception {
        ...
        quan.itemOptions.add(new ItemOption(223, 0));
        gang.itemOptions.add(new ItemOption(223, 0));
        giay.itemOptions.add(new ItemOption(223, 0));
        rd.itemOptions.add(new ItemOption(223, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setLienHoan(Player player) throws Exception {
        ...
        ao.itemOptions.add(new ItemOption(226, 0));
        quan.itemOptions.add(new ItemOption(226, 0));
        gang.itemOptions.add(new ItemOption(226, 0));
        giay.itemOptions.add(new ItemOption(226, 0));
        rd.itemOptions.add(new ItemOption(226, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setPicolo(Player player) throws Exception {
        ...
        ao.itemOptions.add(new ItemOption(225, 0));
        quan.itemOptions.add(new ItemOption(225, 0));
        gang.itemOptions.add(new ItemOption(225, 0));
        giay.itemOptions.add(new ItemOption(225, 0));
        rd.itemOptions.add(new ItemOption(225, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setPikkoroDaimao(Player player) throws Exception {
        ...
        ao.itemOptions.add(new ItemOption(227, 0));
        quan.itemOptions.add(new ItemOption(227, 0));
        gang.itemOptions.add(new ItemOption(227, 0));
        giay.itemOptions.add(new ItemOption(227, 0));
        rd.itemOptions.add(new ItemOption(227, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setKakarot(Player player) throws Exception {
        ...
        Item rd = ItemService.gI().otpKH((short) 12);
        ao.itemOptions.add(new ItemOption(247, 0));
        quan.itemOptions.add(new ItemOption(247, 0));
        gang.itemOptions.add(new ItemOption(247, 0));
        giay.itemOptions.add(new ItemOption(247, 0));
        rd.itemOptions.add(new ItemOption(247, 0));

        ao.itemOptions.add(new ItemOption(219, 0));
        quan.itemOptions.add(new ItemOption(219, 0));
        gang.itemOptions.add(new ItemOption(219, 0));
        giay.itemOptions.add(new ItemOption(219, 0));
        rd.itemOptions.add(new ItemOption(219, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setCadic(Player player) throws Exception {
        ...
        Item giay = ItemService.gI().otpKH((short) 29);
        Item rd = ItemService.gI().otpKH((short) 12);
        ao.itemOptions.add(new ItemOption(217, 0));
        quan.itemOptions.add(new ItemOption(217, 0));
        gang.itemOptions.add(new ItemOption(217, 0));
        giay.itemOptions.add(new ItemOption(217, 0));
        rd.itemOptions.add(new ItemOption(217, 0));

        ao.itemOptions.add(new ItemOption(220, 0));
        quan.itemOptions.add(new ItemOption(220, 0));
        gang.itemOptions.add(new ItemOption(220, 0));
        giay.itemOptions.add(new ItemOption(220, 0));
        rd.itemOptions.add(new ItemOption(220, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
    ...
    public void setNappa(Player player) throws Exception {
        ...
        Item giay = ItemService.gI().otpKH((short) 29);
        Item rd = ItemService.gI().otpKH((short) 12);
        ao.itemOptions.add(new ItemOption(218, 0));
        quan.itemOptions.add(new ItemOption(218, 0));
        gang.itemOptions.add(new ItemOption(218, 0));
        giay.itemOptions.add(new ItemOption(218, 0));
        rd.itemOptions.add(new ItemOption(218, 0));

        ao.itemOptions.add(new ItemOption(221, 0));
        quan.itemOptions.add(new ItemOption(221, 0));
        gang.itemOptions.add(new ItemOption(221, 0));
        giay.itemOptions.add(new ItemOption(221, 0));
        rd.itemOptions.add(new ItemOption(221, 0));
        ao.itemOptions.add(new ItemOption(30, 0));
        quan.itemOptions.add(new ItemOption(30, 0));
        gang.itemOptions.add(new ItemOption(30, 0));
        giay.itemOptions.add(new ItemOption(30, 0));
