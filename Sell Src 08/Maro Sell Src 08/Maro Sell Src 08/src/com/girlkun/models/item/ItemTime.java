...
public class ItemTime {
    ...
    public static final byte TEXT_DO_SAT = 5;
    ...
    public void update() {
        if (isBatGioi) {
            if (Util.canDoWithTime(lastTimeBatGioi, 300000)) {
                isBatGioi = false;
        ...
        if (isDoiNhi) {
            if (Util.canDoWithTime(lastTimeDoiNhi, 1800000)) {
                isDoiNhi = false;
                Service.gI().point(player);
            }
        }
