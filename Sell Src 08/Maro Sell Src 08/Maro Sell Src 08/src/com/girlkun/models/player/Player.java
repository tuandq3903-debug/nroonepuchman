...
import com.girlkun.models.npc.BoMong;
...
public class Player {
    ...
    public int diemdanh = 0;
    public long timevip;
    public byte vip;
    public SkillSpecial skillSpecial;
    public NewSkill newSkill;
    public byte CheckDayOnl;
    public int chucNangNhanBua = 0;
    public double dametong = 0;
    public int point_kibi = 0;
    public int point_dosat = 0;
    public int point_trungthu = 0;
    ...
    //data_chucPhuc
    public int chuc_phuc_sd = 0;
    public int chuc_phuc_hp = 0;
    public int chuc_phuc_ki = 0;
    ...
    public boolean clientLongMessage() {
    ...
    private static final short[][] idOutfitFusion = {
        ...
        {1273, 1274, 1275}, {1279, 1280, 1281}, {1276, 1277, 1278}, //bt3
    ...
    public short getHead() {
        ...
        if (effectSkill != null) {
            if (effectSkill.isTranformation) {
                switch (this.gender) {
                    case 0:
                        ItemTimeService.gI().sendItemTime(this, 12312, this.effectSkill.timeTranformation / 1000);
                        return 1403;
                    case 1:
                        ItemTimeService.gI().sendItemTime(this, 12318, this.effectSkill.timeTranformation / 1000);
                        return 1420;
                    case 2:
                        ItemTimeService.gI().sendItemTime(this, 12306, this.effectSkill.timeTranformation / 1000);
                        return 1440;
                    default:
                }
            }
                ...
                switch (this.gender) {
                    case 0:
                        switch (this.isbienhinh) {
                            case 1:
                                ItemTimeService.gI().removeItemTime(this, 12312);
                                ItemTimeService.gI().sendItemTime(this, 12313, this.effectSkill.timeTranformation / 1000);
                                return 1403;
                            case 2:
                                ItemTimeService.gI().removeItemTime(this, 12313);
                                ItemTimeService.gI().sendItemTime(this, 12314, this.effectSkill.timeTranformation / 1000);
                                return 1406;
                            case 3:
                                ItemTimeService.gI().removeItemTime(this, 12314);
                                ItemTimeService.gI().sendItemTime(this, 12315, this.effectSkill.timeTranformation / 1000);
                                return 1409;
                            case 4:
                                ItemTimeService.gI().removeItemTime(this, 12315);
                                ItemTimeService.gI().sendItemTime(this, 12316, this.effectSkill.timeTranformation / 1000);
                                return 1412;
                            case 5:
                                ItemTimeService.gI().removeItemTime(this, 12316);
                                ItemTimeService.gI().sendItemTime(this, 12317, this.effectSkill.timeTranformation / 1000);
                                return 1415;
                            default:
                        }
                    case 1:
                        switch (this.isbienhinh) {
                            case 1:
                                ItemTimeService.gI().removeItemTime(this, 12318);
                                ItemTimeService.gI().sendItemTime(this, 12319, this.effectSkill.timeTranformation / 1000);
                                return 1423;
                            case 2:
                                ItemTimeService.gI().removeItemTime(this, 12319);
                                ItemTimeService.gI().sendItemTime(this, 12320, this.effectSkill.timeTranformation / 1000);
                                return 1426;
                            case 3:
                                ItemTimeService.gI().removeItemTime(this, 12320);
                                ItemTimeService.gI().sendItemTime(this, 12321, this.effectSkill.timeTranformation / 1000);
                                return 1429;
                            case 4:
                                ItemTimeService.gI().removeItemTime(this, 12321);
                                ItemTimeService.gI().sendItemTime(this, 12322, this.effectSkill.timeTranformation / 1000);
                                return 1432;
                            case 5:
                                ItemTimeService.gI().removeItemTime(this, 12322);
                                ItemTimeService.gI().sendItemTime(this, 12323, this.effectSkill.timeTranformation / 1000);
                                return 1435;
                    ...
                    case 2:
                        switch (this.isbienhinh) {
                            case 1:
                                ItemTimeService.gI().removeItemTime(this, 12306);
                                ItemTimeService.gI().sendItemTime(this, 12307, this.effectSkill.timeTranformation / 1000);
                                return 1440;
                            case 2:
                                ItemTimeService.gI().removeItemTime(this, 12307);
                                ItemTimeService.gI().sendItemTime(this, 12308, this.effectSkill.timeTranformation / 1000);
                                return 1443;
                            case 3:
                                ItemTimeService.gI().removeItemTime(this, 12308);
                                ItemTimeService.gI().sendItemTime(this, 12309, this.effectSkill.timeTranformation / 1000);
                                return 1446;
                            case 4:
                                ItemTimeService.gI().removeItemTime(this, 12309);
                                ItemTimeService.gI().sendItemTime(this, 12310, this.effectSkill.timeTranformation / 1000);
                                return 1449;
                            case 5:
                                ItemTimeService.gI().removeItemTime(this, 12311);
                                ItemTimeService.gI().sendItemTime(this, 12312, this.effectSkill.timeTranformation / 1000);
                                return 1452;
                            default:
                        }
        ...
        if (effectSkill != null && effectSkill.isSocola) {
            return 412;
        } else if (this.itemTime != null && this.itemTime.isBienHinhMa) {
            if (this.gender == 0) {
                return 545;
            }
            if (this.gender == 1) {
            ...
            return 406;
        } else if (this.itemTime != null && this.itemTime.isBatGioi) {
            return 1267;
        } else if (this.itemTime != null && this.itemTime.isDoiNhi) {
            return 654;
