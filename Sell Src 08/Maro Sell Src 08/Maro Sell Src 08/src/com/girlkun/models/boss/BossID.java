...
public class BossID {
    ...
    public static final int BROLY_THUONG = -2;
    ...
    public static final int THO_DAI_CA = 999;
    public static final byte NAPPA = -92;
    public static final byte SAIBAMEN = -93;
    public static final byte SAIBAMEN2 = -94;
    public static final byte SAIBAMEN3 = -95;
    public static final byte SAIBAMEN4 = -96;
    public static final byte SAIBAMEN5 = -97;
    public static final byte SAIBAMEN6 = -98;
    public static final byte VEGETA = -99;
    public static final byte BO_XUONG = -103;
    public static final int BONGBANG = -104;
    public static final int NGUOIVOHINH = -105;
    public static final int THODAUBAC = -106;
    public static final int DRACULA = -107;
    public static final int SATAN = -108;
    public static final int BAT_GIOI = -109;
    public static final int DOI_NHI = -110;
}
