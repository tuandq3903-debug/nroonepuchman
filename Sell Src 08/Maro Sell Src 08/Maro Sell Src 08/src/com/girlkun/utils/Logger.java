...
public class Logger {
    ...
    public static void CheckException(Class clazz, Exception ex, String... log) {
        try {
            ...
            String detail = sw.toString();
            String[] arr = detail.split("\n");
            Logger.warning("Xảy ra ngoại lệ tại class: ");
            Logger.error(clazz.getName());
            Logger.warning(" - tại hàm: ");
            Logger.error(nameMethod + "\n");
            Logger.warning("Chi tiết exception:\n");
            for (String str : arr) {
                Logger.error(str + "\n");
            }
            Logger.log("-------------------------------------------------------------------\n");
