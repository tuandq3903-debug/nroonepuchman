...
//        return 10000;
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        }else if (id >= 1303 && id <= 1308) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id >= 1309 && id <= 1314) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id >= 1315 && id <= 1320) {
            return Skill.SUPER_TRANFORMATION;
        } else if (id == 1321) {
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        }else if (tempId >= 1303 && tempId <= 1308) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId >= 1309 && tempId <= 1314) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId >= 1315 && tempId <= 1320) {
            return getSkillbyId(pl, Skill.SUPER_TRANFORMATION);
        } else if (tempId == 1321) {
