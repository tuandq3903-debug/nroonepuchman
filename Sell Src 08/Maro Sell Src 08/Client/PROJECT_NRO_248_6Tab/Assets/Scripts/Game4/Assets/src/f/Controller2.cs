...
namespace Game4.Assets.src.f
{
	...
	{
		// Token: 0x06001CEC RID: 7404 RVA: 0x001BEE44 File Offset: 0x001BD044
			...
			try
			{
				...
				if (command <= 42)
				{
					...
					case -101:
					{
						...
						Rms.saveRMSString("userAo4" + ServerListScreen.ipSelect.ToString(), text5);
		...
		// Token: 0x06001CED RID: 7405 RVA: 0x001C0D54 File Offset: 0x001BEF54
		...
		// Token: 0x06001CEE RID: 7406 RVA: 0x001C0E38 File Offset: 0x001BF038
		...
		// Token: 0x06001CEF RID: 7407 RVA: 0x001C123C File Offset: 0x001BF43C
		...
		// Token: 0x06001CF0 RID: 7408 RVA: 0x001C1320 File Offset: 0x001BF520
