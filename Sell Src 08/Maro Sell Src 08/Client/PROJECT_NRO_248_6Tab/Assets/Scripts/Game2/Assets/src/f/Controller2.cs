...
namespace Game2.Assets.src.f
{
	...
	{
		// Token: 0x06003034 RID: 12340 RVA: 0x002E8F8C File Offset: 0x002E718C
			...
			try
			{
				...
				if (command <= 42)
				{
					...
					case -101:
					{
						...
						Rms.saveRMSString("userAo2" + ServerListScreen.ipSelect.ToString(), text5);
		...
		// Token: 0x06003035 RID: 12341 RVA: 0x002EAE9C File Offset: 0x002E909C
		...
		// Token: 0x06003036 RID: 12342 RVA: 0x002EAF80 File Offset: 0x002E9180
		...
		// Token: 0x06003037 RID: 12343 RVA: 0x002EB384 File Offset: 0x002E9584
		...
		// Token: 0x06003038 RID: 12344 RVA: 0x002EB468 File Offset: 0x002E9668
