...
namespace Game5.Assets.src.f
{
	...
	{
		// Token: 0x06001348 RID: 4936 RVA: 0x00129DA0 File Offset: 0x00127FA0
			...
			try
			{
				...
				if (command <= 42)
				{
					...
					case -101:
					{
						...
						Rms.saveRMSString("userAo5" + ServerListScreen.ipSelect.ToString(), text5);
		...
		// Token: 0x06001349 RID: 4937 RVA: 0x0012BCB0 File Offset: 0x00129EB0
		...
		// Token: 0x0600134A RID: 4938 RVA: 0x0012BD94 File Offset: 0x00129F94
		...
		// Token: 0x0600134B RID: 4939 RVA: 0x0012C198 File Offset: 0x0012A398
		...
		// Token: 0x0600134C RID: 4940 RVA: 0x0012C27C File Offset: 0x0012A47C
