...
namespace Game3.Assets.src.f
{
	...
	{
		// Token: 0x06002690 RID: 9872 RVA: 0x00253EE8 File Offset: 0x002520E8
			...
			try
			{
				...
				if (command <= 42)
				{
					...
					case -101:
					{
						...
						Rms.saveRMSString("userAo3" + ServerListScreen.ipSelect.ToString(), text5);
		...
		// Token: 0x06002691 RID: 9873 RVA: 0x00255DF8 File Offset: 0x00253FF8
		...
		// Token: 0x06002692 RID: 9874 RVA: 0x00255EDC File Offset: 0x002540DC
		...
		// Token: 0x06002693 RID: 9875 RVA: 0x002562E0 File Offset: 0x002544E0
		...
		// Token: 0x06002694 RID: 9876 RVA: 0x002563C4 File Offset: 0x002545C4
